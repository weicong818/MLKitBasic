...
package com.example.mlkitshow.camera;
...
//you can also use the LensEnginePreview class built in the HMS SDK to locally detect faces in dynamic camera streams.
//then pass the streams to the analyzer.
...
//2.A class with the camera initialization, frame obtaining, and logic control functions encapsulated.
